...
Almost all of the software that I have used in the creation of this book are [FLOSS](Appendix꞉%20FLOSS.md#^floss).
...
Initially, I was using KWord to write the book (as explained in the [history lesson](Appendix꞉%20Revision%20History.md#^history-lesson)).
...
For the eight draft, I used [Vim](https://vim.swaroopch.com/), [Pandoc](http://johnmacfarlane.net/pandoc/README.html), and Mac OS X.
...
See [https://swaroopch.com/about](https://swaroopch.com/about)