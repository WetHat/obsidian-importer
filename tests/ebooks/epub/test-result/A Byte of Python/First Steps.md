...
![When you open PyCharm](pycharm_open.png)

Select `Pure Python`:

![PyCharm New Project](pycharm_create_new_project.png)

Change `untitled` to `helloworld` as the location of the project, you should see details similar to this:

![PyCharm project details](pycharm_create_new_project_pure_python.png)
...
![PyCharm New File dialog box](pycharm_new_file_input.png)

You can now see a file opened for you:

![PyCharm hello.py file](pycharm_hello_open.png)
...
![PyCharm Run 'hello'](pycharm_run.png)
...
![Screenshot of running program in terminal](terminal_screenshot.png)
