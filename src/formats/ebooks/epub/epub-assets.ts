...
export abstract class ImportableAsset {
	...
	/**
	 * Get the path to the asset relative the book in the output folder.
	 *
	 * @see {@link makeAssetPath}
	 *
	 ...
	 * the desired filename of the asset in the book's output folder (including file extension).
	 *
	 * The filename can be substanitally different from the filename used in the epub source to
	 * make it Obsidian friendly.
	 *
	 * @returns Filename of the book in the output folder.
	 */
	abstract get outputFilename(): string;

	/**
	 * @return the filename in the epub source (ZIP) archive.
	 */
	...
	/**
	 *
	 * @param bookOutpuFolder The book's output folder to save the book in.
	 * @returns The imported file.
	 */
	abstract import(bookOutpuFolder: TFolder): Promise<TFile>;

	/**
	 * Get the fully qualified path to the output location of this asset in the Obsidian vault.
	 *
	 * Missing folders in the output path are created if they do not exist.
	 *
	 * @param bookOutputFolder The vaoutput folder
	 * @returns asset vault output path.
	 */
...
/**
 * Adapter for a page in the epub book.
 */
export class PageAsset extends ImportableAsset {
	 ...
	 *
	 * **Note**: The page title also defines the filename of the page (after sanitization).
